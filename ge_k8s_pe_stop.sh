...
function help() {
    ...
    The following variables must be defined in your environment:
     ...
     - GE_K8S_NODE_STOP_SCRIPT           path to the script to teardown a k8s node     
    ">&2
}
...
node_stop_script=${GE_K8S_NODE_STOP_SCRIPT:-"$(script_dir)/ge_k8s_node_stop.sh"}
...
pdsh  -w ${hostlist} "${node_stop_script}"